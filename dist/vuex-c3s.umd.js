(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/slicedToArray'), require('rison-node'), require('vuex'), require('swagger-client')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/slicedToArray', 'rison-node', 'vuex', 'swagger-client'], factory) :
  (global = global || self, global.vuexC3S = factory(global._regeneratorRuntime, global._asyncToGenerator, global._defineProperty, global._slicedToArray, global.rison, global.Vuex, global.Swagger));
}(this, function (_regeneratorRuntime, _asyncToGenerator, _defineProperty, _slicedToArray, rison, vuex, Swagger) { 'use strict';
