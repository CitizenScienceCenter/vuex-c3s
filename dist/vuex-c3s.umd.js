(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vuex'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('swagger-client')) :
  typeof define === 'function' && define.amd ? define(['vuex', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', 'swagger-client'], factory) :
  (global.vuexC3S = factory(global.Vuex,global._defineProperty,global._slicedToArray,global._regeneratorRuntime,global._asyncToGenerator,global.Swagger));
}(this, (function (Vuex,_defineProperty,_slicedToArray,_regeneratorRuntime,_asyncToGenerator,Swagger) { 'use strict';
